...
{
    public static string Format(string originFileName, string pathFormat,string subPath="blog",string album="")
    {
        ...
        pathFormat = pathFormat.Replace("{album}", album);
        pathFormat = pathFormat.Replace("{sub}", subPath);
